...
<?php 
setcookie("resale",$_GET['id']);
$id=$_GET['id'];
  $sql="SELECT * FROM rentproperty WHERE rental_id='$id'";
  $result=query_r($sql);
  $row=mysqli_fetch_all($result,MYSQLI_ASSOC);
    foreach($row as $rows){
       $userid=$rows['uid'];
       setcookie("ownerrent",$userid);      
?>
<div class="row container h_rent">
    ...
    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 disp_price">
       <span>Deposite</span><div class="price">&#8377;<?php echo $rows['deposite_amount'];?></div> 
       <span>per month</span><div class="price">&#8377;<?php echo $rows['monthly_rent'];?></div> 
            ...
            <div class="modal-body">
                ...
                <form method="post">
                   ...
                   <div class="form-group">
                    ...
                    <!-- <div class="form-group"> 
                        <input type="text" class="form-control" name="InputAdd1" placeholder="Apartment,floor" required>
                    </div>
                    <div class="form-group"> 
                    ...
                    <button type="submit" class="btn btn-primary btn-block" name="buyerData">Book</button>
                </form>
            </div>
      </div>
    </div>
